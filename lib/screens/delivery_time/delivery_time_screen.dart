...
import 'package:piscine_app/blocs/user/user_bloc.dart';
import 'package:piscine_app/blocs/user/user_state.dart';
...
import 'package:piscine_app/models/delivery_time_model.dart';
import 'package:piscine_app/models/models.dart';
                      ...
                      if (currentuser != null) {
                        {
                          ...
                          sendNotification('Book Appointment added', token!);
                          ...
                          const snackBar = SnackBar(
                              content: Text('Rendez-vous bien ajouté !!!',
